...
int main() {
    ...
    LedSignResult res6 = addSubBoard(6,63,40,1,1);
    ...
    LedSignResult res22 = addPicture(9,58,35,4,5,55,25,95,19);
    if(res22 != LED_SIGN_SUCCESS){
        printf("res22 ERROR!!\n");
    }
    LedSignResult res23 = addPicture(11,57,35,2,5,55,25,95,19);
    if(res23 != LED_SIGN_ANOTHER_OBJECT_LOCATED_THERE){
        printf("res23 ERROR!!\n");
    }
    LedSignResult res24 = updatePicture(5,11,55,25,100,2);
    if(res24 != LED_SIGN_NO_PICTURE_WITH_THE_GIVEN_ID){
        printf("res24 ERROR!!\n");
    }
    LedSignResult res25 = updatePicture(5,9,55,25,100,2);
